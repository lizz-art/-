...
begin_im = pygame.image.load('data/begin.png')
im1 = pygame.image.load('data/1.png')
im2 = pygame.image.load('data/2.png')
im3 = pygame.image.load('data/3.png')
go_im = pygame.image.load('data/gameover.png')
gobg_im = pygame.image.load('data/gameover_bg.png')
gomm_im = pygame.image.load('data/gameover_mm.png')
